          ...
          <IonCardContent >
            <IonGrid>
              <IonRow>
                <IonCol size="12">
                  <IonItem>
                    <IonLabel position="floating" style={{textAlign:"center", fontSize:"25px"}}>Nombre</IonLabel>
                    <br />
                    <IonInput
                      value={name}
                ...
                <IonCol size="12">
                  <IonItem>
                    <IonLabel position="floating" style={{textAlign:"center", fontSize:"25px" }}>Descripción</IonLabel>
                    <br />
                    <IonInput
                      value={description}
